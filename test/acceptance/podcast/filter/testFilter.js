...
var React = require('react'); //var ReactTestUtils = require('react-addons-test-utils');
...
describe('test/acceptance/podcast/filter/testFilter.jsx', function () {
  it('[klingon klaxon] should filter number of records', function () {
    ...
    var filter_input = reactTestHelpers.oneReactByClass(document_render, 'TEXT-FILTER'); // nb, as the podcast component is small it can only show a max of 8 rows
