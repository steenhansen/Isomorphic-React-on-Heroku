...
//var = require('react-addons-test-utils');
...
describe('test/acceptance/rsd/genre/testGenre.jsx', function () {
    ...
    ReactTestUtils.Simulate.change(select, {target: {value: 'story'}});
    ...
    ReactTestUtils.Simulate.change(select, {target: {value: 'poem'}});
    ...
    ReactTestUtils.Simulate.change(select, {target: {value: 'other'}});
