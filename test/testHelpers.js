...
var testHelpers = {
    ...
    arrayOfObjectsToString: function (array_of_objects){
        ...
        for (let key in array_of_objects) {
            ...
            string_accum = string_accum + ':' + key.trim() + ':' + value.trim() + ":\n"
        }
        return string_accum
    },
    ...
    //    console.log(tabs_windows_1)
    //    console.log('2222222222222222222222222222')
    //    console.log(tabs_windows_2)
    ...
    xmlDifference: function (xml_1, xml_2) {
        ...
        for (var i = 0; i < xml_count; i++) {
            ...
            if (xml_production_1 != xml_production_2) {
                const line_number = i+1
                var sentence_difference = testHelpers.sentenceDifference(xml_production_1, xml_production_2, line_number)
