...
//console.log( '227777222', process.argv[3]);
...
rootAppRequire('test/integration/saveTestToDb/failure/saveTestToDb_fail'); 
 //    // [yuletide yak][zero zebra][fancy flags][grim gold][indian iris][red blue][strong bad]
 //    // [artificial art][somber sombraro][goofy golf][trex apex][same same]

rootAppRequire('test/integration/saveTestToDb/success/saveTestToDb_pass'); 
// [eloping elephants][dread deer][aardvarks anonymous]
 ...
 rootAppRequire('test/unit/diFactory/ParserTsvTextCreate'); // [the big club]
  rootAppRequire('test/unit/miscMethods/miscMethods'); // [xerox xerces]
                 //       [happy hippos][jinxed jallopy][kinky kill] [lame limerick]
