...
var reactTestHelpers = {
    ...
    oneReactByClass: function (document_render, class_name) {
        var rendered_component = ReactTestUtils.findRenderedDOMComponentWithClass(document_render, class_name)
    ...
    reactClassCount: function (document_render, class_name) {
        var rendered_component = ReactTestUtils.scryRenderedDOMComponentsWithClass(document_render, class_name)
