...
describe('test/integration/saveRealToDb/success/saveRealToDb.js', function () {
    ...
    describe("good data should", function () {
        ...
        beforeEach(function (doneCallback) {
            ...
            screenOutput.html_saveRealToDb_P4(variables_tsv, parser_tsv, rsd_media, media_constants.REAL_DATA, the_information, media_file_loc).then(
                function onFulfilled(html) {
                    correct_test_path = true
                    screenOutput.html_saveRealToRss_P5(variables_tsv, parser_tsv, rsd_media, media_constants.REAL_DATA, the_information, media_file_loc).then(
        ...
        it('produce correct html', function () {
            ...
            expect(the_diff).toEqual('', 'expect output !== actual output 1231234523')
        })

    })


    describe("[bulging bag] good data should 123153 ", function () {
        var correct_test_path = false
        ...
        beforeEach(function (doneCallback) {
            screenOutput.xmlAdminViewRealIframeP3(rsd_media).then(
        ...
        it('produce correct rss xml', function () {
            var the_diff = testHelpers.whiteSpaceFileDiff(produced_file, expected_rss)
            expect(the_diff).toEqual('', 'expect output !== actual output123 23')
        })
