...
class PdfComponent extends MediaComponent {
    ...
    constructor(props) {
        ...
        this.search_columns = ['book author', 'book title',
            'pdf info 1', 'pdf country 1', 
            'pdf info 2', 'pdf country 2',
            'pdf info 3', 'pdf country 3',
            'pdf info 4', 'pdf country 4',
            'pdf page count 1'
        ];
    ...
    changeGrid(changed_data) {
        ...
        if (this.filter_text === '') {
            ...
            var {filteredIndexes, search_matches} = this.pdf_list.filterDataSet(this.filter_text, sortIndexes);
    ...
    render() {
        var {pdf_clear_css, clear_hover_css, column_sort_css}=this.generateCss();
        ...
        return (
            <div id="pdf-media-container">
                <PdfDescription pdf_description={this.media_description}/>
                {the_counts}
                <br/>
                <style scoped dangerouslySetInnerHTML={{__html: clear_hover_css}}/>
                <button onClick={this.clearAllFilters} style={pdf_clear_css} className="pdf-clear CLEAR-TEXT">Reset
                </button>
                ...
                <PdfTitles cb_PdfComponent_titleSort={this._onSortChange}/>
                <PdfTable data={this.pdf_list}
