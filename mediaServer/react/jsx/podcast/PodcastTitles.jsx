...
class PodacstTitles extends React.Component {
    constructor(props) {
        super(props);
        ...
        this.sort_directions = {"episode_number": 1, "book author_": 1, "book title_": 1, "hh:mm:ss": 1};
    ...
    render() {
        ...
        return (
            <div >
                ...
                <button className="EPISODE-SORT podcast-sort" onClick={this.clickEpisodeNumber}
                        style={podcast_sort_css}>{title_episode_number}</button>
                <button className="TIME-SORT podcast-sort" onClick={this.clickHhMmSs}
                        style={podcast_sort_css}>{title_hh_mm_ss}</button>
                <button className="TITLE-SORT podcast-sort" onClick={this.clickBookTitle}
                        style={podcast_sort_css}>{title_book_title}</button>
                <button className="AUTHOR-SORT podcast-sort" onClick={this.clickBookAuthor}
                        style={podcast_sort_css}>{title_book_author}</button>
            </div>
        );
