    ...
    _createClass(KindSelect, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(Option, { category: 'All Kinds',
                    hidden_category: '',
                    key: 'kind_all' }),
                React.createElement(Option, { category: 'Audiobook',
                    hidden_category: 'audiobook',
                    key: 'kind_audiobook' }),
                React.createElement(Option, { category: 'Audiobook/Readalong',
                    hidden_category: 'audiobook/readalong',
                    key: 'kind_audiobook_readalong' }),
                React.createElement(Option, { category: 'New Releases/Recent Arrivals',
                    hidden_category: 'new releases/recent arrivals',
                    key: 'kind_new_releases_recent_arrivals' }),
                React.createElement(Option, { category: 'Readalong',
                    hidden_category: 'readalong',
                    key: 'kind_readalong' }),
                React.createElement(Option, { category: 'Talk To',
                    hidden_category: 'talk to',
                    key: 'kind_talk_to' }),
                React.createElement(Option, { category: 'Topic',
