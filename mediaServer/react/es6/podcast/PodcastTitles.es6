    ...
    _createClass(PodacstTitles, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(
                    'button',
                    { className: 'EPISODE-SORT podcast-sort', onClick: this.clickEpisodeNumber,
                        style: podcast_sort_css },
                    title_episode_number
                ),
                React.createElement(
                    'button',
                    { className: 'TIME-SORT podcast-sort', onClick: this.clickHhMmSs,
                        style: podcast_sort_css },
                    title_hh_mm_ss
                ),
                React.createElement(
                    'button',
                    { className: 'TITLE-SORT podcast-sort', onClick: this.clickBookTitle,
                        style: podcast_sort_css },
                    title_book_title
                ),
                React.createElement(
                    'button',
                    { className: 'AUTHOR-SORT podcast-sort', onClick: this.clickBookAuthor,
                        style: podcast_sort_css },
                    title_book_author
                )
            );
