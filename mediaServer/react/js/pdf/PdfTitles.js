...
class PdfTitles extends React.Component {
  ...
  render() {
    ...
    var {
      ...
      'pdf page count 1': title_page_count
    } = this.current_titles;
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("style", {
      ...
      className: "EPISODE-SORT pdf-sort",
      onClick: this.clickEpisodeNumber,
      style: pdf_sort_css
    }, title_episode_number), /*#__PURE__*/React.createElement("button", {
      className: "TITLE-SORT pdf-sort",
      onClick: this.clickBookTitle,
      style: pdf_sort_css
    }, title_book_title), /*#__PURE__*/React.createElement("button", {
      className: "AUTHOR-SORT pdf-sort",
      onClick: this.clickBookAuthor,
      style: pdf_sort_css
    }, title_book_author), /*#__PURE__*/React.createElement("button", {
      className: "PAGE-SORT pdf-sort",
      onClick: this.clickPageCount,
      style: pdf_sort_css
    }, title_page_count)); // UPPERCASE className is for testing!!   EPISODE-SORT
  }
