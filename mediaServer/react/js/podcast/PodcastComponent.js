...
class PodcastComponent extends MediaComponent {
  ...
  changeGrid(changed_data) {
    ...
    if (this.filter_text === '') {
      ...
      var {
        filteredIndexes,
        search_matches
      } = this.podcast_list.filterDataSet(this.filter_text, sortIndexes);
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, /*#__PURE__*/React.createElement(PodcastDescription, {
      podcast_description: this.media_description
      ...
      style: podcast_clear_css,
      className: "podcast-clear CLEAR-TEXT"
      ...
      autoComplete: "off",
      placeholder: "Search ..."
    }), " ", match_message, /*#__PURE__*/React.createElement(KindSelect, {
      cb_PodcastComponent_filterByKind: this.filterByKind,
    ...
    }), /*#__PURE__*/React.createElement(PodcastTitles, {
      cb_PodcastComponent_titleSort: this._onSortChange
    }), /*#__PURE__*/React.createElement(PodcastTable, {
      data: this.podcast_list,
