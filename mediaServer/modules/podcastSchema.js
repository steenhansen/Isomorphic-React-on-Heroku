...
var podcast_schema = {
  ...
  google_media_tab: config_environment.PODCAST_GOOGLE_DATA,
  google_variables_tab: config_environment.PODCAST_GOOGLE_VARIABLES,
  ...
  must_contain: {
    ...
    kind:
      '(audiobook|audiobook/readalong|new releases/recent arrivals|readalong|talk to|topic)',
  ...
  contain_errors: {
    ...
    kind:
      'Audiobook OR Audiobook-Readalong OR New Releases-Recent Arrivals OR Readalong OR Talk To OR Topic',
...
objectAssign(podcast_schema.item_schema, base_schema);
