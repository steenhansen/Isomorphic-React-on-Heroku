...
var rsd_information = {
    ...
    must_contain: {
        ...
        "book title": ".{3,}",
        "book author": ".{3,}",
        "genre type": "(Poem|Story|Other|poem|story|other)",
    ...
    tsv_variables: ['media_title', 'media_web_page', 'media_directory_url', 'media_description', 'media_copyright', 'media_rss_location',
...
objectAssign(rsd_information.item_schema, base_schema)

module.exports = rsd_information
