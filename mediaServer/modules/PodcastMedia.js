...
PodcastMedia.prototype.rssFeed = function (
  data_rows,
  ...
  return BaseMedia.prototype.rssFeed.call(
    this,
    data_rows,
    tsv_variable_information,
    item_template,
...
PodcastMedia.prototype.saveXmlRss = function (rss_xml, real_or_test) {
  return BaseMedia.prototype.upsertDocument.call(
    this,
    podcast_items_db,
    'rss_document',
    'all_rss_xml',
...
PodcastMedia.prototype.getDocument = function (
  document_id,
  field_id,
  real_or_test
) {
  return BaseMedia.prototype.getDocument.call(
    this,
    podcast_items_db,
    document_id,
    field_id,
...
PodcastMedia.prototype.collectionAsString_test = function () {
  return BaseMedia.prototype.collectionAsString_test.call(
    this,
    podcast_items_db
  );
};
...
PodcastMedia.prototype.deleteItems = function (real_or_test) {
  return BaseMedia.prototype.deleteItems.call(
    this,
    podcast_items_db,
    real_or_test
  );
...
PodcastMedia.prototype.deleteDocument = function (
  document_name,
  real_or_test /* :string */
) {
  return BaseMedia.prototype.deleteDocument.call(
    this,
    podcast_items_db,
    document_name,
    real_or_test
...
PodcastMedia.prototype.upsertDocument = function (
  document_name,
  variable_name,
  the_value,
  real_or_test
...
PodcastMedia.prototype.saveDescription = function (
  description_text,
  real_or_test
) {
  return BaseMedia.prototype.saveDescription.call(
    this,
    podcast_items_db,
    description_text,
    real_or_test
...
PodcastMedia.prototype.deriveData = function (
  data_columns,
  offset_minutes,
  tsv_variables
) {
  ...
  var data_dated = BaseMedia.prototype.deriveDate.call(
    this,
    data_filed,
    offset_minutes
  );
  data_dated['post_link'] =
    tsv_variables.post_link_prefix + data_dated['post id'];
  return data_dated;
};
PodcastMedia.prototype.splitVersions = function (
  data_rows_compact,
  offset_minutes,
  tsv_variables
) {
  for (const row_index in data_rows_compact) {
    ...
    var data_derived = this.deriveData(
      start_row,
      offset_minutes,
      tsv_variables
    );
...
PodcastMedia.prototype._itemTemplateVars = function (
  data_row,
  podcast_episode_digits
) {
  var episode_number = data_row['episode number'];
  var episode_digit = shared_methods.leadingZerosDigits(
    podcast_episode_digits,
    episode_number
  );
...
PodcastMedia.prototype._pageTemplateVars = function (
  rsd_items_html,
  tsv_variable_information,
  itunes_summary
) {
  return BaseMedia.prototype._pageTemplateVars.call(
    this,
    rsd_items_html,
    tsv_variable_information,
    itunes_summary
...
PodcastMedia.prototype.currentList = function (max_records) {
  return BaseMedia.prototype.currentList.call(
    this,
    max_records,
    podcast_items_db
  );
