...
var rsd_schema = {
  ...
  google_media_tab: config_environment.RSD_GOOGLE_DATA,
  google_variables_tab: config_environment.RSD_GOOGLE_VARIABLES,
  ...
  contain_errors: {
    ...
    'post link':
      'need a valid link like http://www.sffaudio.com/reading-short-and-deep...',
    ...
    'pdf link':
      'need a valid pdf link like http://www.sffaudio.com/podcasts/TheWolfByGuyDeMaupassant.pdf',
    'video link':
      'need a valid video link like https://www.youtube.com/watch?v=tc6Xzxt_vig',
...
objectAssign(rsd_schema.item_schema, base_schema);
