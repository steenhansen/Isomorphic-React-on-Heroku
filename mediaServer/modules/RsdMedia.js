...
RsdMedia.prototype.rssFeed = function (
  data_rows,
...
RsdMedia.prototype.getDocument = function (
  document_id,
  field_id,
  real_or_test
) {
...
RsdMedia.prototype.dropCollection = function () {
  return BaseMedia.prototype.dropCollection.call(this, rsd_items_db);
};
...
RsdMedia.prototype.deleteDocument = function (
  document_name,
  real_or_test /* :string */
) {
...
RsdMedia.prototype.upsertDocument = function (
  document_name,
  variable_name,
  the_value,
  real_or_test
...
RsdMedia.prototype.splitVersions = function (
  data_rows_compact,
  offset_minutes,
  tsv_variables
) {
...
RsdMedia.prototype._pageTemplateVars = function (
  rsd_items_html,
  tsv_variable_information,
  itunes_summary,
  host_url
