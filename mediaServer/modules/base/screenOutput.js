...
module.exports = function (save_rss_items, media_url_dirs) {
  var screenOutput = {
    html_checkItemsForCron_P0: function (
      variables_tsv,
      parser_tsv,
      the_media,
      the_information,
      ...
      return save_rss_items
        ...
        .then(function (num_records_saved) {
          ...
          var save_test_to_db_html = media_file_loc.htmlFiles(
            media_url_dirs.ADMIN_checkItemsForCron_P0
          );
    ...
    html_saveTestToRss_P2: function (
      variables_tsv,
      parser_tsv,
      the_media,
      media_file_loc,
    ...
    html_viewTestRss_P3: function (the_information, media_file_loc) {
      var view_test_rss_html = media_file_loc.htmlFiles(
        media_url_dirs.ADMIN_viewTestRss_P3
      );
    ...
    html_saveRealToRss_P5: function (
      variables_tsv,
      parser_tsv,
      the_media,
      media_file_loc,
    ...
    htmlPublicShowPlayer: function (
      ...
      return the_media
        .getDocument(
          id,
          media_constants.ENTIRE_DOCUMENT,
          media_constants.REAL_DATA
        )
        .then(function (media_data) {
          ...
          var podpress_html = media_file_loc.htmlFiles(
            media_url_dirs.PUBLIC_SHOW_PLAYER
          );
          var player_template_vars = the_media.playerTemplateVars(media_data);
          var page_html = miscMethods.getFillSwig(
            podpress_html,
            player_template_vars
          );
          return page_html;
        })
        .catch(function (e) {
          global.Method_logger.exception(
            "htmlPublicShowPlayer",
            module.filename,
            e
          );
    ...
    htmlAdminShowAll: function (the_information, media_file_loc, host_url) {
      var view_all_html = media_file_loc.htmlFiles(
        media_url_dirs.ADMIN_SHOW_ALL_OUTPUT
      );
      var link_to_player_1 =
        media_url_dirs.URL_HTML_PUBLIC_SHOW_PLAYER + "?id=1";
