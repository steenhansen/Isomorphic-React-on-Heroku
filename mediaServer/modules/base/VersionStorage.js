...
VersionStorage.prototype.saveNewVersion = function (
  media_rows /*:Array<MediaRows>*/,
  real_or_test /*:string*/
) {
  var self = this;
  return this._current_media
    .deleteItems(real_or_test)
    .then(function () {
      return self._current_media.deleteDocument("description", real_or_test);
    })
    .then(function () {
      return self._current_media.saveDocument(
        "description",
        "itunes_summary",
        self._media_description_text,
        real_or_test
      );
    })
    .then(function () {
    ...
    .then(function (promise_inserted_rows) {
...
VersionStorage.prototype.rowsPromised = function (
  media_row,
  real_or_test /*:string*/
) {
...
VersionStorage.prototype._insertRows = function (
  media_rows /*:Array<MediaRows>*/,
  real_or_test /*:string*/
) {
  var promises_arr = [];
