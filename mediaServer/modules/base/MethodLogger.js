...
module.exports = function (log_dir, environment_type) {
  ...
  //  From https://stackoverflow.com/questions/51074805/typeerror-winston-logger-is-not-a-constructor-with-winston-and-morgan
  // var Method_Logger = new (winston.Logger)({

  let Method_Logger = winston.createLogger({
    transports: [
  ...
  var functionLogger = {
    ...
    chronicle: function (log_type, method_name, method_file) {
      //, var1_name, var1_value, var2_name, var2_value, var3_name, var3_value
    ...
    //  if (log_type === "error") {
//      if (process.env.I_AM_TESTING !== "yes") {




  //     console.log('OOOO', process.env.I_AM_TESTING   );


    //    console.log("ssssssssssssssssssssssssssss", method_name, method_file);           // q*bert
      //  console.log("testging???", log_type, log_message);
     // }
